...
我们欢迎[report Issues](../issues) 或者 [pull requests](../pulls)。 在贡献代码之前请阅读以下指引。
...
我们欢迎大家贡献代码来使我们的bk-chatbot更加强大 代码团队会监控所有的pull request, 我们会做相应的代码检查和测试，测试通过之后我们就会接纳PR ，但是不会立即合并到master分支。
