...
TASK_SKILL_SELECTED_PROMPT = _('{} 已选择：{}\n{}')
TASK_DEL_SCHEDULER_SUCCESS_MSG = _('定时器删除成功')
TASK_SKILL_LABEL = _('自定义任务')
TASK_EXECUTE_BUTTON = _('执行')
TASK_CANCEL_BUTTON = _('取消')
TASK_VALIDATE_PARAMS_MSG = _('参数不合法，会话中断')
TASK_CREATE_SCHEDULER_SUCCESS_PREFIX = _('「定时」任务创建成功 时间')
TASK_URL_TIP = _('任务链接')
TASK_PARAMS_ERROR_TIP = _('参数有误')
TASK_API_ABNORMAL_TIP = _('第三方服务异常')
TASK_APPROVE_MSG = _('该技能已交由{}审批')
TASK_APPROVE_REQ_MSG = _('{}的技能「{}」执行权限申请，请您审批\n执行参数: {}')
TASK_APPROVE_TITLE_SUFFIX = _('BKCHAT任务审批')
TASK_APPROVE_PINDING_MSG = _('提单中...')
TASK_LIST_SCHEDULER_TITLE = _('BKCHAT定时任务')
TASK_LIST_SCHEDULER_PREFIX = _('当前定时任务如下:')
TASK_DEL_SCHEDULER_BUTTON = _('删除')
