# Generated by Django 2.2.6 on 2021-12-21 14:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_by",
                    models.CharField(blank=True, default="admin", max_length=255, null=True, verbose_name="创建人"),
                ),
                (
                    "created_at",
                ...
                (
                    "updated_by",
                    models.CharField(blank=True, default="admin", max_length=255, null=True, verbose_name="更新人"),
                ),
                ("updated_at", common.models.base.FormatDateTimeField(auto_now=True, null=True, verbose_name="更新时间")),
                ("is_deleted", models.BooleanField(default=False, verbose_name="是否删除")),
                (
                    "deleted_by",
                    models.CharField(blank=True, default="admin", max_length=255, null=True, verbose_name="删除人"),
                ),
                ...
                (
                    "timer_type",
                    models.IntegerField(
                        choices=[(0, "DEFAULT"), (1, "ONCE"), (2, "REPEAT")], default=0, verbose_name="定时任务类型"
                    ),
                ),
                (
                    "timer_status",
                    models.IntegerField(choices=[(1, "OPEN"), (2, "CLOSE")], default=1, verbose_name="定时任务状态"),
                ),
