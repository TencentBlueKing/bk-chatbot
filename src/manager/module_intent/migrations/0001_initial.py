# Generated by Django 2.2.16 on 2022-03-14 18:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', common.models.json.DictCharField(default={}, verbose_name='机器人配置')),
            ],
            options={
                'verbose_name': '【机器人】',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_user', common.models.json.DictCharField(default=[], verbose_name='可执行用户')),
                ('available_group', common.models.json.DictCharField(default=[], verbose_name='可执行群组')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slots', common.models.json.DictCharField(default=[], verbose_name='槽位信息')),
                ('source', common.models.json.DictCharField(default={}, verbose_name='任务元数据')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biz_id', models.PositiveIntegerField(db_index=True, default=0, verbose_name='业务ID')),
                ('index_id', models.BigIntegerField(default=-1, verbose_name='索引ID')),
                ('content', common.models.json.DictCharField(default=[], verbose_name='语料列表')),
            ],
            options={
                'verbose_name': '【语料库】',
