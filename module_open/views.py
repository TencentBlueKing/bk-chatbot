...
class OpenChatBindViewSet(APIModelViewSet, ValidationMixin):
    """
    无登陆态群聊绑定业务
    """
    ...
    def perform_create(self, serializer):
        ...
        GroupBindHandler(serializer.instance.chat_group_id).\
            hash_set_redis_data(
    ...
    def perform_destroy(self, instance):
        ...
        ChatBindBusiness.objects.filter(chat_group_id=instance.chat_group_id)\
            .update(
